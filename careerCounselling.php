    ...
    <section id="aboutUs">
        <div class="jumbotron mb-0">
            <div class="chooseUs mx-auto">
                <h2>Career Counselling</h2><br>
                <p class="mb-0">Meritline helps the students and their families choose a college, university and other programs that is the perfect match for the student. Guiding the student throughout their admission process regarding which course to choose, which college to go for and other valuable stuffs is the only motive of Meritline.</p><br>
                <p class="mb-0">Good Education will no more be an imagination as, with our admission guidance services, student can seek admissions in any colleges of Bangalore.</p>
            </div>
        </div>
    </section>
    <!-- about section end -->
