    ...
    <section id="aboutUs">
        <div class="jumbotron">
            <div class="chooseUs mx-auto">
                ...
                <p class="mb-0">We provide secured admissions by connecting you with the right college and we make the whole process a lot easier.</p>
            </div>
        </div>
    </section>
    <!-- about section end -->
