...
<i class="fa fa-phone my-float"></i>
   ...
   <div style="background-image: url('img/cover-img2.jpg'); 
    ...
    <!-- about section start -->
    <section id="awardsAndAchivements">
        <div class="jumbotron mb-0 light-section">
            <div class="row align-items-center">
                <div class="col-12 col-md-4 offset-md-1">
                    <img class="img-thumbnail" src="img/meritline-justdial.jpeg" alt="">
                </div>
                <div class="col-12 offset-md-1 col-md-5">
                    <p>Meritline has been honored with Justdial 5 star Quality service award</p>
                </div>
            </div>
        </div>
        <div class="dark-section py-5">
            <div class="row align-items-center">
                <div class="col-12 offset-md-1 col-md-6 mb-5">
                    <div class="card">
                        <img src="img/meritline-iso-certificate.jpg" class="card-img-top" style="height: 100%;" alt="...">
                        <div class="card-body">
                          <p class="card-text">Meritline An ISO 9001:2008 Certified Education Consultancy.</p>
                        </div>
                      </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="row">
                        <div class="col-12 mb-4 mb-md-2">
                            <img class="img-thumbnail" src="img/meritline-counter.jpeg" alt="">
                        </div>
                        <div class="col-12 mt-4 mt-md-2 pb-md-3">
                            <img class="img-thumbnail" src="img/meritline-excellence.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="jumbotron mb-0">
            <div class="row align-items-center">
                <div class="col-12 offset-md-1 col-md-5">
                    <p>Awarded Most Impactful Career Counselling And Education Consultancy In Bangalore in 2019 by India Excellence Awards.</p>
                </div>
                <div class="col-12 col-md-4 offset-md-1">
                    <video poster="img/meritline-excellence-thumbnail.png" controls>
                        <source src="img/meritline-excellence-award.mp4" type="video/mp4">
