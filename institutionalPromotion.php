    ...
    <section id="aboutUs">
        <div class="jumbotron mb-0">
            <div class="chooseUs mx-auto">
                <h2>Intitutional Promotion</h2><br>
                <p class="mb-0">Institutional promotion is the promotion of the organization as a whole- its ethics, values, goodwill, its sense of social responsibility, in an effort to improve the brand recognition and increase its public relationship appeal. It is considered generally as a form of advertising.</p>
            </div>
        </div>
    </section>
    <!-- about section end -->
